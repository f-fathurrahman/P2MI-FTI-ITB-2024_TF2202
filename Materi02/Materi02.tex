...
Misalkan kita memiliki "komputer" basis-10 dengan unit penyimpan angka
...
vertikal pendek. Bilangan-bilangan lainnya akan mengalami galat pemotongan.
...
\epsilon = b^{1-t}
$$
b: base, t: jumlah digit signifikan pada mantissa
